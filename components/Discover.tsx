...
const Discover = () => {
    ...
    const activeTopicStyle = "lg:border-2 hover:bg-primary lg:border-[#F51997] p-3 rounded lg:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#F51997]";
