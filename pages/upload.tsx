...
const Upload = () => {
    ...
    return (
        ...
        mb-10 pt-10 px-2 lg:pt-20 bg-[#F8F8F8] justify-center">
            <div className="bg-white rounded-lg xl:h-[80vh] flex gap-6 
            flex-wrap justify-center items-center p-14 pt-6">
                ...
                <div className="flex flex-col gap-3 pb-10">
                    ...
                    <select
                        ...
                        className="outline-none border-2 border-gray-200 text-md capitalize lg:p4 p-2 rounded cursor-pointer"
                    >
                        {topics.map((topic) => (
                            <option
                                key={topic.name}
                    ...
                    <div className="flex gap-6 mt-10">
                        ...
                        <button
                            onClick={handlePost}
                            type="button"
                            className="text-md font-medium text-white bg-[#F51997]
                          p-2 rounded w-28 lg:w-44 outline-none"
                        >
                            Post
                        </button>
